...
In a really conservative scenario this amount will double within years, due to capital injection of institutional investors as well as amatorial investors, mostly attracted by the idea of quick gains as well as the opportunity to contrast inflation.
...
The rise of web3 has opened up new form of interactions between users and platforms, in which there is no need anymore of a central autority to grant certain rules, for example the idea of KYC is no longer required.
...
Most of them are really complex to use, they often have too many features and their UIs are often overloaded with elements, generating confusion and uncertanties among non crypto-savvy users.

Others are more user friendly, but black boxed, which means not open source or not easy sharable across users.
...
They often hide themselft behind "normal looking" social media accounts. They are keen to know more about new interesting possibilities offered by the crypto economy, but without exposing or revealing themself. They share their knowledge with a limited circle of connection and they do not have interest in expanding their network further. Potentially they could find favorable the possibility of mentoring new comers.
...
Despite so, it is rare to see an influencer sharing precisly the amount invested, or the total profit generated. There is no certanties the profit they claim to make, nor there is a possibility to verify if what they say is accurate. Execpt a few cases, most of the influencers do not fully monetize their crypto abilities.

Influencers users are loud leaders able to take initiative.

### Newcomers users
Newcomers are those traders which have interest in crypto but still they are not fully part of the movement. Their lack of experience, they have strong risk adversion, limiting the potential of their success. They like to follow other traders, gathering ideas of new tokens to invest on, as well as when it is time to enter or leave a position.

They do not hide themself on social media, and they usually like to belong to bigger community. Due to an overwhealming amount of information available online, it is often difficult for newcomer to choose an influencer to follow.
...
This openess allows the possibility to create a "infinitive scrolling experience" in which at a glance it is possibile to see what other users have done in terms of crypto investments. A user can scroll through the feed, jumping to a trader's profile particulary interesting. Here after having explored the macro portfolio, the user can open a single trade to visualise the details, add a comment, and potentially follow the trader.
...
Users are able to enter the plaform using their Web3 wallets, this means TradingLab does not store any personal data.
...
These are only three of the scenarios in which smart contracts can be applied to TradingLab. During the development of this project the team will develpp new skills and competences making possibile to envision new ideas.
...
Once the product is considered pleasent to use, the idea is to onboard experienced crypto users, possibily generating a network effect able to dramatically increase the amount of users on the platform.
...
* Q2 2022: starting onboarding users, adding new functionalities
